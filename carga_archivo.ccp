	...
	<Components>
		<Record id="2" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="NewRecord1" actionPage="carga_archivo" errorSummator="Error" wizardFormMethod="post" PathID="NewRecord1">
			<Components>
				...
				<ListBox id="3" visible="Yes" fieldSourceType="DBColumn" sourceType="SQL" dataType="Text" returnValueType="Number" name="ListBox1" PathID="NewRecord1ListBox1" connection="ConnCarga" dataSource="select id_periodo,  CONVERT(varchar,fecha_corte,103) as periodo
from  SO_Cat_FechasCorte_Sabanas where estado ='Habilitado' order by fecha_corte asc" boundColumn="id_periodo" textColumn="periodo">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
		...
		<Label id="37" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="lb_no_logeo" PathID="lb_no_logeo">
<Components/>
<Events/>
<Attributes/>
<Features/>
