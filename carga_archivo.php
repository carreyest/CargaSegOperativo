...
//Class_Initialize Event @2-031BF5C9
    function clsRecordNewRecord1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ListBox1->DataSource = new clsDBConnCarga();
            ...
            $this->ListBox1->DataSource->SQL = "select id_periodo,  CONVERT(varchar,fecha_corte,103) as periodo\n" .
            "from  SO_Cat_FechasCorte_Sabanas where estado ='Habilitado' {SQL_OrderBy}";
            $this->ListBox1->DataSource->Order = "fecha_corte asc";
...
$Header->Initialize();
$lb_no_logeo = new clsControl(ccsLabel, "lb_no_logeo", "lb_no_logeo", ccsText, "", CCGetRequestParam("lb_no_logeo", ccsGet, NULL), $MainPage);
$MainPage->NewRecord1 = & $NewRecord1;
$MainPage->Header = & $Header;
$MainPage->lb_no_logeo = & $lb_no_logeo;
$ScriptIncludes = "";
...
//Go to destination page @1-6B11A14E
if($Redirect)
{
